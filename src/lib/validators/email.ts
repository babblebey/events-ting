...
const SUSPICIOUS_PATTERNS = [
  {
    pattern: /^no-?reply@/i,
    message: "Email appears to be a no-reply address",
  },
  ...
  {
    pattern: /^do-?not-?reply@/i,
    message: "Email appears to be a do-not-reply address",
  },
  {
    pattern: /\+\d+@/,
    message: "Email contains numbers after + sign (might be temporary)",
  },
